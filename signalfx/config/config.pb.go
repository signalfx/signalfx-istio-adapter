...
type Params_TracingConfig struct {
	...
	// Optional. Tags (key:value pairs) that will be added to every span emitted by the agent.
	GlobalSpanTags map[string]string `protobuf:"bytes,8,rep,name=global_span_tags,json=globalSpanTags" json:"global_span_tags,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *Params_TracingConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.GlobalSpanTags) > 0 {
		for k, _ := range m.GlobalSpanTags {
			dAtA[i] = 0x42
			i++
			v := m.GlobalSpanTags[k]
...
func (m *Params_TracingConfig) Size() (n int) {
	...
	if len(m.GlobalSpanTags) > 0 {
		for k, v := range m.GlobalSpanTags {
			_ = k
			_ = v
...
func (this *Params_TracingConfig) String() string {
	...
	keysForGlobalSpanTags := make([]string, 0, len(this.GlobalSpanTags))
	for k, _ := range this.GlobalSpanTags {
		keysForGlobalSpanTags = append(keysForGlobalSpanTags, k)
	}
	sortkeys.Strings(keysForGlobalSpanTags)
	mapStringForGlobalSpanTags := "map[string]string{"
	for _, k := range keysForGlobalSpanTags {
		mapStringForGlobalSpanTags += fmt.Sprintf("%v: %v,", k, this.GlobalSpanTags[k])
	}
	mapStringForGlobalSpanTags += "}"
	s := strings.Join([]string{`&Params_TracingConfig{`,
		...
		`GlobalSpanTags:` + mapStringForGlobalSpanTags + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Params_TracingConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field GlobalSpanTags", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.GlobalSpanTags == nil {
				m.GlobalSpanTags = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.GlobalSpanTags[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipConfig(dAtA[iNdEx:])
...
var fileDescriptorConfig = []byte{
	...
	,
}
